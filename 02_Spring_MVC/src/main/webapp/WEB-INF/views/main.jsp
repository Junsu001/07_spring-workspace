...
<body>
		<!-- / 또는 /main.do라는 url mapping으로 요청시 해당 /WEB-INF/views/main.jsp가 보여지도록 -->
		<h1>메인페이지 입니다</h1>
	 ...
	 <h3>3. 요청시 전달 되는 파라미터 처리 연습(request parameter)</h3>
   <!-- HttpServletRequest방법 -->
   ...
   <form action="${ contextPath }/member/enroll1.do" method="post">
      ...
      <button type="submit">등록</button>
		...
		<!-- @RequestParam 방법 -->
		<a href="${ contextPath }/member/detail2.do?no=1">회원 상세 조회</a>
   	<br><br>
