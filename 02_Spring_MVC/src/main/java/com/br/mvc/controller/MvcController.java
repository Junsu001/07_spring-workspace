...
/*
 * * @Controller
 * - 클라이언트 요청을 처리할 클래스를 Bean으로 등록하기 위해서 작성하는 어노테이션
 ...
 * 	 <annotation-driven> 에 의해서 @Controller가 활성화 됨
 * 
 */
@Controller
public class MvcController {
	 ...
	 *      - void   : 딱히 반환값이 없을 경우 응답할 jsp 경로 url 매핑값과 동일하게 인식됨
	 ...
	 *        ㄴ RedirectAttributes arr : redirect 할 때 필요한 데이터(flash attribute)를 담는 객체
	 *		    
	 */
