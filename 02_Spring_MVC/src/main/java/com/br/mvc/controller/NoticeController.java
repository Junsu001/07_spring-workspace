...
//  직접 생성하면 결합도가 높아지는 문제 발생
	...
	*/
	...
	// 상단에 @RequiredArgsConstructor 어노테이션을 사용하면
	// 현재 필드들 중에서 final예약어가 붙은 어노테이션만 생성자로 만들어짐
	// 필드에 String과 int형 등의 타입 변수가
	// 여러개 깔려 있을 경우 이 경우가 유용할 수 있음.
...
//		mv.setViewName("notice/detail");
	...
	@GetMapping("/modifyForm.do")
	 public ModelAndView updateNotice(int no, ModelAndView mv) {
		mv.addObject("notice", noticeService.selectNoticeByNo(no))
		  .setViewName("notice/modifyForm");
