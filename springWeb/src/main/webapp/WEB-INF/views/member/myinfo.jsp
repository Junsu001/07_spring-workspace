...
<div class="container p-3">
        ...
        <section class="row m-3" style="min-height: 500px">
          ...
          <div class="container border p-5 m-4 rounded">
            ...
            <div align="center">
                <img id="profileImg" src="${ contextPath }<c:out value='${ loginUser.profileURL }' default='/resources/images/맹구.jpeg' />" onclick="$('#profileImgFile').click();">
                <input type="file"  class="file" id="profileImgFile" style="display:none;" accept="image/*"><!-- accept를 쓰면 이미지파일만 선택할수있다 -->
            </div>
